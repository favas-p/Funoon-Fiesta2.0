    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
          ...
          <div className="flex-1 space-y-2">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Badge className="text-lg px-3 py-1 bg-cyan-100 text-cyan-800 border-cyan-200">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-lg text-gray-900">{team.name}</span>
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 bg-white border-gray-200 shadow-md">
          ...
          <p className="text-2xl font-bold text-green-600">{stats.completedPrograms}</p>
        </Card>
        <Card className="p-4 bg-white border-gray-200 shadow-md">
          <div className="flex items-center gap-2 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-6 bg-white border-gray-200 shadow-md">
          <CardTitle className="mb-4 text-gray-900">Points by Section</CardTitle>
        ...
        {/* Wins Distribution */}
        <Card className="p-6 bg-white border-gray-200 shadow-md">
          <CardTitle className="mb-4 text-gray-900">Wins Distribution</CardTitle>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
                data={winsData}
        ...
        {/* Grades Distribution */}
        <Card className="p-6 bg-white border-gray-200 shadow-md">
          <CardTitle className="mb-4 text-gray-900">Grades Distribution</CardTitle>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
                data={gradesData}
        ...
        {/* Program Status */}
        <Card className="p-6 bg-white border-gray-200 shadow-md">
          <CardTitle className="mb-4 text-gray-900">Program Status</CardTitle>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
                data={statusData}
      ...
      {performanceData.length > 0 && (
        <Card className="p-6 bg-white border-gray-200 shadow-md">
          <CardTitle className="mb-4 text-gray-900">Performance Over Time</CardTitle>
      ...
      {/* Programs List */}
      <Card className="p-6 bg-white border-gray-200 shadow-md">
        <CardTitle className="mb-4 text-gray-900">All Programs</CardTitle>
        <div className="space-y-3">
          {registrations.length === 0 ? (
            ...
            registrations.map((reg) => {
              ...
              return (
                <Card key={reg.id} className="p-4 bg-gray-50 border-gray-200">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h3 className="font-semibold text-gray-900">{reg.program.name}</h3>
                        <Badge
                          className={`${STATUS_COLORS[reg.status]} border`}
                        >
